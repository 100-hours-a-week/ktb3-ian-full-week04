...
public interface PostApi {
    ...
    ResponseEntity<ApiResponse<PageResponse<PostResponse>>> getAllPosts(@Valid PageRequest pageRequest);
    ...
    ResponseEntity<ApiResponse<PostDetailResponse>> createPost(
            @Authentication LoggedInUser loggedInUser,
